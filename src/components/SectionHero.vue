...
/* ── Transformación de paralaje para móvil (giroscopio) ── */
...
/* ── Motor de Descifrado Criptográfico (< 300ms) ─── */
...
onMounted(async () => {
  ...
  /* Fase 1: Revelado criptográfico del nombre */
  await scrambleReveal(nameEl.value, FULL_NAME)

  /* Fase 2: Línea separadora azul cobalto */
  gsap.fromTo(lineEl.value,
    { scaleX: 0, opacity: 0 },
    { scaleX: 1, opacity: 1, duration: 0.35, ease: 'power3.out' }
  )

  /* Fase 3: Subtítulos con clip-path ascendente */
  ...
  /* Fase 4: Foto de perfil — fade-in con desplazamiento ascendente */
    ...
    <div class="relative z-10 section-container flex flex-col md:flex-row items-center min-h-screen gap-12 md:gap-8">
      ...
      <div class="w-full md:w-3/5 flex flex-col justify-center order-2 md:order-1">
        ...
        <div ref="ctasEl" class="mt-8 flex flex-wrap items-center gap-4 opacity-0">
          ...
          <button href="#contacto" class="btn-secondary">Iniciar Proyecto</button>

          <!-- Iconos de Redes Sociales -->
          <div class="flex items-center gap-3 ml-1">
            <!-- GitHub -->
            <a href="https://github.com/ElTapiaGit" target="_blank" rel="noopener"
               class="p-2 rounded-lg border border-slate-800 text-slate-500 hover:text-slate-200 hover:border-slate-600 transition-colors">
            ...
            <!-- LinkedIn -->
            <a href="https://linkedin.com/in/jhon-tapia" target="_blank" rel="noopener"
               class="p-2 rounded-lg border border-slate-800 text-slate-500 hover:text-slate-200 hover:border-slate-600 transition-colors">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- WhatsApp -->
            <a href="https://wa.me/59171234567" target="_blank" rel="noopener"
               class="p-2 rounded-lg border border-slate-800 text-slate-500 hover:text-slate-200 hover:border-slate-600 transition-colors">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="relative w-full md:w-2/5 flex justify-center order-1 md:order-2">
        ...
        >
          <div class="w-[260px] md:w-[320px] lg:w-[380px] rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 shadow-2xl">
            <img
              :src="IMAGE_SRC"
          ...
          <div class="absolute -inset-4 rounded-2xl border border-blue-900/20 -z-10"></div>
        </div>
      </div>
